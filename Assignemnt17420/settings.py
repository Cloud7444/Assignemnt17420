"""
Django settings for Assignemnt17420 project.
...
SECRET_KEY = 'hqcq&%-pv(io$37s3*u2pjfuo7dj1(t$$k)37y5joxg5)ids7!'
...
ROOT_URLCONF = 'Assignemnt17420.urls'
...
WSGI_APPLICATION = 'Assignemnt17420.wsgi.application'
